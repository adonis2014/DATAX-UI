...
public class Generate {
	...
	public static void main(String[] args) {
		...
		fields.add(new Field("createDate", "建立日期", "Date"));
		fields.add(new Field("updateDate", "更新日期", "Date"));
		fields.add(new Field("createId", "建立者", "createId"));
		fields.add(new Field("updateId", "更新人", "updateId"));

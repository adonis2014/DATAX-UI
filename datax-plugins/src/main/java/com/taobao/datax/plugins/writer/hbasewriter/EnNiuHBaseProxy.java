...
public class EnNiuHBaseProxy {
	...
	public static EnNiuHBaseProxy newProxy(String hbase_conf, String table) 
			throws IOException {
		return new EnNiuHBaseProxy(hbase_conf, table);
	}
	
	private EnNiuHBaseProxy(String hbase_conf, String tableName)
			throws IOException {

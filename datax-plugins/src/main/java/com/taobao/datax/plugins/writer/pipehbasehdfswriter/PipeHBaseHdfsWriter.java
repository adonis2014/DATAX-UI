...
public class PipeHBaseHdfsWriter  extends Writer{
	...
	private Logger logger = Logger.getLogger(PipeHBaseHdfsWriter.class);
	...
	public List<PluginParam> split(PluginParam param) {
		PipeHBaseHdfsWriterSplitter spliter = new PipeHBaseHdfsWriterSplitter();
	...
	public int init() {
		...
		try {
			this.proxy = PipeHBaseHdfsProxy.newProxy(hbase_conf, tablename,this.bufferSize);
			try{
	...
	public int startWrite(LineReceiver receiver) {
		...
		PipeDataProcessor dataProcessor=new PipeDataProcessor(proxy);

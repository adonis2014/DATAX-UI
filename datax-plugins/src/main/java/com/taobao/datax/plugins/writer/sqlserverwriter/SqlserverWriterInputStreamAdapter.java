...
package com.taobao.datax.plugins.writer.sqlserverwriter;
...
public class SqlserverWriterInputStreamAdapter extends InputStream {
    ...
    public SqlserverWriterInputStreamAdapter(LineReceiver reader, SqlserverWriter writer) {
        super();

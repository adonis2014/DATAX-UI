...
public interface ArbitrateConstants {
     ...
     * otter的channel的根节点
     */
    public String NODE_PROJECT_ROOT       = NODE_OTTER_ROOT + "/project";

    /**
     * otter中channel节点的format格式,接受channelId做为参数
     */
    public String NODE_PROJECT_FORMAT     = NODE_PROJECT_ROOT + "/{0}";

    /**
     * otter中pipeline节点的format格式,接受channelId,pipelineId做为参数
     */
    public String NODE_PIPELINE_FORMAT    = NODE_PROJECT_FORMAT + "/{1}";

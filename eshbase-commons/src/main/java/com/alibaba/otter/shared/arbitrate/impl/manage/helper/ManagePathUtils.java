...
public class ManagePathUtils {
    ...
    public static String getProjectRoot() {
        return ArbitrateConstants.NODE_PROJECT_ROOT;
    }
     ...
     */
    public static String getProjectByProjectId(Long channelId) {
        // 根据channelId 构造path
        return MessageFormat.format(ArbitrateConstants.NODE_PROJECT_FORMAT, String.valueOf(channelId));
    }

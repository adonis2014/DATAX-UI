...
public class StagePathUtils extends ManagePathUtils {
    ...
    public static String getPipeline(Long pipelineId) {
        ...
        return MessageFormat.format(ArbitrateConstants.NODE_PIPELINE_FORMAT, getProjectId(pipelineId),
     ...
     * 返回对应的channel path
     */
    public static String getProject(Long pipelineId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_PROJECT_FORMAT, getProjectId(pipelineId));
    }
    ...
    public static String getRemedyRoot(Long pipelineId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_REMEDY_ROOT, getProjectId(pipelineId),
                                    String.valueOf(pipelineId));
    }
    ...
    public static String getProcessRoot(Long pipelineId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_PROCESS_ROOT, getProjectId(pipelineId),
                                    String.valueOf(pipelineId));
    }
    ...
    public static String getProcess(Long pipelineId, Long processId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_PROCESS_FORMAT, getProjectId(pipelineId),
    ...
    public static String getTerminRoot(Long pipelineId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_TERMIN_ROOT, getProjectId(pipelineId),
                                    String.valueOf(pipelineId));
    }
    ...
    public static String getTermin(Long pipelineId, Long processId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_TERMIN_FORMAT, getProjectId(pipelineId),
                                    String.valueOf(pipelineId), getProcessNode(processId));
    }
    ...
    public static String getLockRoot(Long pipelineId) {
        // 根据channelId , pipelineId构造path
        return MessageFormat.format(ArbitrateConstants.NODE_LOCK_ROOT, getProjectId(pipelineId),
                                    String.valueOf(pipelineId));
    }
    ...
    private static String getProjectId(Long pipelineId) {
        Project project = ArbitrateConfigUtils.getProject(pipelineId);

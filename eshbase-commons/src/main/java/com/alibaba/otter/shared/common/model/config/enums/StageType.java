...
public enum StageType {
    ...
    SELECTLOG,LOADQUEUE,SELECT, EXTRACT, TRANSFORM, LOAD;

    public boolean isSelectLog() {
        return this.equals(StageType.SELECTLOG);
    }
    
    public boolean isLoadQueue() {
        return this.equals(StageType.LOADQUEUE);
    }

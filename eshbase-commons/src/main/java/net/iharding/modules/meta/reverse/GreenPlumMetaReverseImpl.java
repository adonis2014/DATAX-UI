...
@Repository("MetaReverse16")
public class GreenPlumMetaReverseImpl  implements MetaReverseDao{
    ...
    @Override
    public Dataset reverseTableMeta(DataSource datasource, List<MetaProperty> mproes, User cuser, String dbName,
                                    String tableName) {
        // TODO Auto-generated method stub
        return null;
    }

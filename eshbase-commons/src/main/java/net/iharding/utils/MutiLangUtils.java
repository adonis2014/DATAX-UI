...
public class MutiLangUtils {
	...
	{
		List<MultiLang> langKeyList = getMutiLangInstance().findBy( "langKey", lang_key);
	...
	{
		List<MultiLang> langContextList = getMutiLangInstance().findBy("langContext", lang_context);
	 ...
	 */
	public static MultiLangService getMutiLangInstance()
	{

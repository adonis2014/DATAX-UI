...
-- ----------------------------
--  Sequence structure for seq_etl_job_log
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_etl_job_log";
CREATE SEQUENCE "public"."seq_etl_job_log" INCREMENT 1 START 45 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_etl_job_log" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for seq_etl_param_column
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_etl_param_column";
CREATE SEQUENCE "public"."seq_etl_param_column" INCREMENT 1 START 45 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_etl_param_column" OWNER TO "postgres";
...
-- ----------------------------
--  Sequence structure for seq_job_reg_center
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_job_reg_center";
CREATE SEQUENCE "public"."seq_job_reg_center" INCREMENT 1 START 1 MAXVALUE 99999999999999999 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_job_reg_center" OWNER TO "postgres";
...
-- ----------------------------
--  Sequence structure for seq_meta_datasource
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_meta_datasource";
CREATE SEQUENCE "public"."seq_meta_datasource" INCREMENT 1 START 3 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_meta_datasource" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for seq_meta_dbcolumn
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_meta_dbcolumn";
CREATE SEQUENCE "public"."seq_meta_dbcolumn" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_meta_dbcolumn" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for seq_meta_dbindex
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_meta_dbindex";
CREATE SEQUENCE "public"."seq_meta_dbindex" INCREMENT 1 START 6 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_meta_dbindex" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for seq_meta_dbtable
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_meta_dbtable";
CREATE SEQUENCE "public"."seq_meta_dbtable" INCREMENT 1 START 5 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_meta_dbtable" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for seq_meta_module
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_meta_module";
CREATE SEQUENCE "public"."seq_meta_module" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_meta_module" OWNER TO "postgres";

-- ----------------------------
--  Sequence structure for seq_meta_project
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_meta_project";
CREATE SEQUENCE "public"."seq_meta_project" INCREMENT 1 START 18 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_meta_project" OWNER TO "postgres";
...
-- ----------------------------
--  Sequence structure for seq_sys_multi_lang
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."seq_sys_multi_lang";
CREATE SEQUENCE "public"."seq_sys_multi_lang" INCREMENT 1 START 1004 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "public"."seq_sys_multi_lang" OWNER TO "postgres";
...
INSERT INTO "public"."cms_article" VALUES ('69', 'black', null, '2014-08-07', '作为对象的创建模式，单例模式确保某一个类只有一个实例，而且自行实例化并向整个系统提供这个实例。这个类称为单例类。', '108', null, null, '1', '设计模式', '设计模式-责任型模式-单例模式', '0', '29', '0', '2015-12-22', '5', '5');
COMMIT;
...
CREATE TABLE "public"."etl_plugin_param" (
	"id" int8 NOT NULL DEFAULT nextval('seq_etl_plugin_param'::regclass),
...
CREATE TABLE "public"."etl_task_param" (
	"id" int8 NOT NULL DEFAULT nextval('seq_etl_task_param'::regclass),
	"task_id" int8,
...
CREATE TABLE "public"."sys_dict" (
	"id" int4 NOT NULL DEFAULT nextval('seq_sys_dict'::regclass),
	"code_type" int4,
...
INSERT INTO "public"."sys_dict" VALUES ('803', '10', '3', 'HDFS Seq文件', '3', 'HDFS Seq文件');
INSERT INTO "public"."sys_dict" VALUES ('804', '10', '4', 'ElasticSeach库', '4', 'ElasticSeach库');
...
INSERT INTO "public"."sys_dict" VALUES ('13', '2', '4', '索引类型', '4', '索引类型');
INSERT INTO "public"."sys_dict" VALUES ('15', '2', '6', '字段显示类型', '6', '字显示类型');
INSERT INTO "public"."sys_dict" VALUES ('14', '2', '5', '表单显示类型', '5', '表单显示类型');
INSERT INTO "public"."sys_dict" VALUES ('1002', '1', '1', '是否', '1', '是否显示');
INSERT INTO "public"."sys_dict" VALUES ('1003', '1', '2', '成功/失败', '2', '成功/失败');
INSERT INTO "public"."sys_dict" VALUES ('1004', '1003', '0', '成功', '1', '成功');
INSERT INTO "public"."sys_dict" VALUES ('1005', '1003', '-1', '失败', '2', '失败');
INSERT INTO "public"."sys_dict" VALUES ('1006', '1002', '1', '是', '1', '是');
INSERT INTO "public"."sys_dict" VALUES ('1007', '1002', '0', '否', '2', '否');
INSERT INTO "public"."sys_dict" VALUES ('1008', '12', '1', '关系数据库表', '1', '关系数据库表');
INSERT INTO "public"."sys_dict" VALUES ('1009', '12', '2', '视图', '2', '视图');
INSERT INTO "public"."sys_dict" VALUES ('1010', '12', '3', 'HBase表', '3', 'HBase表');
INSERT INTO "public"."sys_dict" VALUES ('1011', '12', '4', 'Phoenix表', '4', 'Phoenix表');
INSERT INTO "public"."sys_dict" VALUES ('1012', '12', '5', 'phoenix视图', '5', 'phoenix视图');
INSERT INTO "public"."sys_dict" VALUES ('1013', '12', '6', 'es数据表', '6', 'es数据表');
INSERT INTO "public"."sys_dict" VALUES ('1014', '13', '1', 'ElasticSearch索引', '1', 'ElasticSearch索引');
INSERT INTO "public"."sys_dict" VALUES ('1015', '13', '2', 'Solr索引', '2', 'Solr索引');
INSERT INTO "public"."sys_dict" VALUES ('1016', '13', '3', 'HBase二级索引', '3', 'HBase二级索引');
INSERT INTO "public"."sys_dict" VALUES ('1017', '13', '4', 'Phoenix二级索引', '4', 'Phoenix二级索引');
INSERT INTO "public"."sys_dict" VALUES ('1018', '13', '5', '关系数据库索引', '5', '关系数据库索引');
INSERT INTO "public"."sys_dict" VALUES ('17', '1', '17', '启用标记', '17', '启用标记');
INSERT INTO "public"."sys_dict" VALUES ('18', '1', '18', '是否', '18', '是否');
INSERT INTO "public"."sys_dict" VALUES ('16', '1', '16', '执行状态', '16', '执行状态');
INSERT INTO "public"."sys_dict" VALUES ('1019', '17', '1', '启用', '1', '启用');
INSERT INTO "public"."sys_dict" VALUES ('1020', '17', '0', '停用', '2', '停用');
INSERT INTO "public"."sys_dict" VALUES ('1021', '16', '1', '完成', '1', '完成');
INSERT INTO "public"."sys_dict" VALUES ('1022', '16', '2', '执行中', '2', '执行中');
INSERT INTO "public"."sys_dict" VALUES ('1023', '16', '0', '未执行', '3', '未执行');
INSERT INTO "public"."sys_dict" VALUES ('1024', '18', '1', '是', '1', '是');
INSERT INTO "public"."sys_dict" VALUES ('1025', '18', '0', '否', '2', '否');
INSERT INTO "public"."sys_dict" VALUES ('19', '1', '19', '作业类型', '19', '作业类型');
...
CREATE TABLE "public"."meta_module" (
	"id" int8 NOT NULL DEFAULT nextval('seq_meta_module'::regclass),
	"datasource_id" int8,
...
COMMENT ON COLUMN "public"."meta_module"."check_label" IS '启用标记';

-- ----------------------------
--  Records of meta_module
-- ----------------------------
BEGIN;
INSERT INTO "public"."meta_module" VALUES ('2', '2', 'net.iharding.modules.meta', '2015-12-14', '2015-12-14', '5', '5', 'postgres', '2', 'postgresql', 'meta', null);
INSERT INTO "public"."meta_module" VALUES ('1', '1', 'net.iharding.showcase.user', '2015-12-14', '2015-12-14', '5', '5', 'ehbase', '2', 'EHBASE用户表范例', 'user', null);
COMMIT;

-- ----------------------------
--  Table structure for sys_multi_lang
-- ----------------------------
DROP TABLE IF EXISTS "public"."sys_multi_lang";
CREATE TABLE "public"."sys_multi_lang" (
	...
	"id" int8 NOT NULL DEFAULT nextval('seq_sys_multi_lang'::regclass)
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."sys_multi_lang" OWNER TO "postgres";

COMMENT ON TABLE "public"."sys_multi_lang" IS '多国语言字典';
COMMENT ON COLUMN "public"."sys_multi_lang"."lang_key" IS '语言主键';
COMMENT ON COLUMN "public"."sys_multi_lang"."lang_context" IS '内容';
COMMENT ON COLUMN "public"."sys_multi_lang"."lang_code" IS '语言';
COMMENT ON COLUMN "public"."sys_multi_lang"."id" IS 'id';

-- ----------------------------
--  Records of sys_multi_lang
-- ----------------------------
BEGIN;
INSERT INTO "public"."sys_multi_lang" VALUES ('user.name', '姓名2', 'zh_CN', '1003');
COMMIT;
...
INSERT INTO "public"."sys_log" VALUES ('30', '登录系统', '系统登录', '2015-12-18 15:46:53.546', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('31', '退出系统', '系统登出', '2015-12-18 15:55:14.961', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('32', '登录系统', '系统登录', '2015-12-18 15:55:16.466', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('33', '登录系统', '系统登录', '2015-12-18 15:57:09.976', '1', '5', '192.168.20.249');
INSERT INTO "public"."sys_log" VALUES ('34', '登录系统', '系统登录', '2015-12-18 16:23:13.578', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('35', '登录系统', '系统登录', '2015-12-18 16:34:24.492', '1', '5', '192.168.20.70');
INSERT INTO "public"."sys_log" VALUES ('36', '登录系统', '系统登录', '2015-12-18 16:35:21.816', '1', '5', '192.168.20.70');
INSERT INTO "public"."sys_log" VALUES ('37', '登录系统', '系统登录', '2015-12-22 15:12:44.162', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('38', '退出系统', '系统登出', '2015-12-23 15:00:05.801', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('39', '登录系统', '系统登录', '2015-12-23 15:00:07.136', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('40', '退出系统', '系统登出', '2015-12-23 15:01:28.566', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('41', '登录系统', '系统登录', '2015-12-23 15:01:29.934', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('42', '退出系统', '系统登出', '2015-12-23 16:59:59.109', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('43', '登录系统', '系统登录', '2015-12-23 17:07:40.711', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('44', '退出系统', '系统登出', '2015-12-23 17:07:44.35', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('45', '登录系统', '系统登录', '2015-12-23 17:07:48.975', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('46', '退出系统', '系统登出', '2015-12-23 17:07:56.423', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('47', '登录系统', '系统登录', '2015-12-23 17:08:26.369', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('48', '退出系统', '系统登出', '2015-12-23 17:08:29.151', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('49', '登录系统', '系统登录', '2015-12-23 17:09:14.749', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('50', '登录系统', '系统登录', '2015-12-23 17:13:57.274', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('51', '登录系统', '系统登录', '2015-12-30 23:41:13.268', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('52', '登录系统', '系统登录', '2016-01-08 23:45:16.428', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('53', '退出系统', '系统登出', '2016-01-08 23:46:39.645', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('54', '登录系统', '系统登录', '2016-01-08 23:46:40.733', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('55', '登录系统', '系统登录', '2016-01-08 23:58:15.15', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('56', '登录系统', '系统登录', '2016-01-09 15:48:20.425', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('57', '登录系统', '系统登录', '2016-01-09 15:51:34.82', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('58', '登录系统', '系统登录', '2016-01-09 16:03:32.664', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('59', '登录系统', '系统登录', '2016-01-09 17:04:06.556', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('60', '登录系统', '系统登录', '2016-01-09 17:14:14.269', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('61', '登录系统', '系统登录', '2016-01-09 17:15:28.889', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('62', '登录系统', '系统登录', '2016-01-09 17:19:38.612', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('63', '登录系统', '系统登录', '2016-01-09 17:25:42.42', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('64', '登录系统', '系统登录', '2016-01-09 17:29:12.897', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('65', '登录系统', '系统登录', '2016-01-09 17:31:29.329', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('66', '登录系统', '系统登录', '2016-01-25 15:06:15.411', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('67', '登录系统', '系统登录', '2016-01-25 15:11:27.898', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('68', '登录系统', '系统登录', '2016-01-26 11:57:42.721', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('69', '登录系统', '系统登录', '2016-01-26 12:47:01.274', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('70', '登录系统', '系统登录', '2016-01-26 13:51:17.556', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('71', '登录系统', '系统登录', '2016-01-26 13:54:48.941', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('72', '登录系统', '系统登录', '2016-01-26 14:00:12.149', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('73', '登录系统', '系统登录', '2016-01-26 14:02:01.802', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('74', '登录系统', '系统登录', '2016-01-26 14:14:32.321', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('75', '登录系统', '系统登录', '2016-01-26 14:51:36.673', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('76', '登录系统', '系统登录', '2016-01-26 15:04:42.634', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('77', '登录系统', '系统登录', '2016-01-26 16:06:54.643', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('78', '登录系统', '系统登录', '2016-01-26 16:14:20.202', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('79', '登录系统', '系统登录', '2016-01-26 16:28:18.558', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('80', '登录系统', '系统登录', '2016-01-26 16:31:30.732', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('81', '退出系统', '系统登出', '2016-01-26 16:33:01.176', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('82', '登录系统', '系统登录', '2016-01-26 16:33:02.406', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('83', '登录系统', '系统登录', '2016-01-26 16:49:52.929', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('84', '登录系统', '系统登录', '2016-01-26 16:55:18.725', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('85', '登录系统', '系统登录', '2016-01-26 17:02:28.374', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('86', '登录系统', '系统登录', '2016-01-26 17:05:31.235', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('87', '登录系统', '系统登录', '2016-01-26 17:15:50.608', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('88', '登录系统', '系统登录', '2016-01-26 17:16:25.81', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('89', '登录系统', '系统登录', '2016-01-26 17:48:27.811', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('90', '登录系统', '系统登录', '2016-01-26 17:52:21.854', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('91', '登录系统', '系统登录', '2016-01-26 18:04:21.457', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('92', '登录系统', '系统登录', '2016-01-26 18:31:37.342', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('93', '登录系统', '系统登录', '2016-01-26 19:02:59.611', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('94', '退出系统', '系统登出', '2016-01-26 19:07:13.352', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('95', '登录系统', '系统登录', '2016-01-26 19:07:14.545', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('96', '登录系统', '系统登录', '2016-01-26 19:09:56.414', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('97', '登录系统', '系统登录', '2016-01-26 19:14:42.265', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('98', '登录系统', '系统登录', '2016-01-26 19:20:57.646', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('99', '登录系统', '系统登录', '2016-01-26 19:48:56.791', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('100', '登录系统', '系统登录', '2016-01-26 19:54:44.761', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('101', '登录系统', '系统登录', '2016-01-26 20:01:39.886', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('102', '登录系统', '系统登录', '2016-01-26 20:17:17.579', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('103', '登录系统', '系统登录', '2016-01-26 20:21:52.352', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('104', '登录系统', '系统登录', '2016-01-26 20:25:56.678', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('105', '登录系统', '系统登录', '2016-01-26 20:29:10.842', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('106', '登录系统', '系统登录', '2016-01-26 23:44:27.695', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('107', '登录系统', '系统登录', '2016-01-27 00:02:08.887', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('108', '登录系统', '系统登录', '2016-01-27 10:19:29.166', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('109', '登录系统', '系统登录', '2016-01-27 10:37:42.144', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('110', '登录系统', '系统登录', '2016-01-27 10:41:07.045', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('111', '登录系统', '系统登录', '2016-01-27 10:49:32.249', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('112', '登录系统', '系统登录', '2016-01-27 10:51:50.54', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('113', '登录系统', '系统登录', '2016-01-27 11:23:16.324', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('114', '登录系统', '系统登录', '2016-01-27 11:26:24.828', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('115', '登录系统', '系统登录', '2016-01-27 11:34:46.759', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('116', '登录系统', '系统登录', '2016-01-27 11:41:05.601', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('117', '登录系统', '系统登录', '2016-01-27 15:00:43.348', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('118', '登录系统', '系统登录', '2016-01-27 15:55:38.688', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('119', '登录系统', '系统登录', '2016-01-27 16:20:41.129', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('120', '登录系统', '系统登录', '2016-01-27 16:23:39.376', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('121', '登录系统', '系统登录', '2016-01-27 16:24:12.138', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('122', '登录系统', '系统登录', '2016-01-27 16:27:55.198', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('123', '登录系统', '系统登录', '2016-01-27 16:30:07.262', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('124', '登录系统', '系统登录', '2016-01-27 16:37:38.157', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('125', '登录系统', '系统登录', '2016-01-27 16:48:22.506', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('126', '登录系统', '系统登录', '2016-01-27 16:54:32.032', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('127', '登录系统', '系统登录', '2016-01-27 16:58:04.813', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('128', '登录系统', '系统登录', '2016-01-27 17:01:56.277', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('129', '登录系统', '系统登录', '2016-01-27 17:05:10.309', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('130', '登录系统', '系统登录', '2016-01-27 17:08:31.335', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('131', '登录系统', '系统登录', '2016-01-27 17:31:10.585', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('132', '登录系统', '系统登录', '2016-01-27 17:37:37.989', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('133', '登录系统', '系统登录', '2016-01-27 17:46:05.586', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('134', '登录系统', '系统登录', '2016-01-27 17:57:18.017', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('135', '登录系统', '系统登录', '2016-01-27 18:01:29.578', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('136', '登录系统', '系统登录', '2016-01-27 18:06:26.848', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('137', '登录系统', '系统登录', '2016-01-27 18:10:27.7', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('138', '登录系统', '系统登录', '2016-01-27 18:39:23.827', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('139', '登录系统', '系统登录', '2016-01-27 18:43:14.647', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('140', '登录系统', '系统登录', '2016-01-27 18:46:16.779', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('141', '登录系统', '系统登录', '2016-01-27 18:51:30.742', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('142', '登录系统', '系统登录', '2016-01-27 18:57:52.058', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('143', '登录系统', '系统登录', '2016-01-27 19:11:16.051', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('144', '登录系统', '系统登录', '2016-01-27 19:31:31.251', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('145', '登录系统', '系统登录', '2016-01-27 19:35:28.84', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('146', '登录系统', '系统登录', '2016-01-27 19:39:24.643', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('147', '登录系统', '系统登录', '2016-01-27 19:47:26.533', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('148', '登录系统', '系统登录', '2016-01-27 19:57:11.709', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('149', '登录系统', '系统登录', '2016-01-27 19:59:58.968', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('150', '登录系统', '系统登录', '2016-01-27 20:03:32.478', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('151', '登录系统', '系统登录', '2016-01-27 20:10:25.815', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('152', '登录系统', '系统登录', '2016-01-27 23:18:52.351', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('153', '登录系统', '系统登录', '2016-01-27 23:31:23.631', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('154', '登录系统', '系统登录', '2016-01-28 00:03:06.807', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('155', '登录系统', '系统登录', '2016-01-28 14:17:14.827', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('156', '登录系统', '系统登录', '2016-01-28 14:21:09.774', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('157', '登录系统', '系统登录', '2016-01-28 14:32:34.064', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('158', '登录系统', '系统登录', '2016-01-28 14:40:01.561', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('159', '登录系统', '系统登录', '2016-01-28 14:44:37.694', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('160', '登录系统', '系统登录', '2016-01-28 16:26:11.361', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('161', '登录系统', '系统登录', '2016-01-28 16:30:48.844', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('162', '登录系统', '系统登录', '2016-01-28 16:52:53.024', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('163', '登录系统', '系统登录', '2016-01-28 16:56:33.467', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('164', '登录系统', '系统登录', '2016-01-28 17:04:19.163', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('165', '登录系统', '系统登录', '2016-01-28 17:10:46.061', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('166', '登录系统', '系统登录', '2016-01-28 17:16:29.25', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('167', '登录系统', '系统登录', '2016-01-28 17:21:42.229', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('168', '登录系统', '系统登录', '2016-01-28 17:23:23.031', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('169', '登录系统', '系统登录', '2016-01-28 17:27:19.012', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('170', '登录系统', '系统登录', '2016-01-28 17:33:30.026', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('171', '登录系统', '系统登录', '2016-01-28 17:44:12.494', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('172', '登录系统', '系统登录', '2016-01-28 18:01:27.476', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('173', '登录系统', '系统登录', '2016-01-28 18:46:20.649', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('174', '登录系统', '系统登录', '2016-01-28 19:37:56.574', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('175', '登录系统', '系统登录', '2016-01-28 20:00:47.322', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('176', '退出系统', '系统登出', '2016-01-28 20:01:08.563', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('177', '登录系统', '系统登录', '2016-01-28 20:01:09.697', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('178', '退出系统', '系统登出', '2016-01-28 20:01:34.267', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('179', '登录系统', '系统登录', '2016-01-28 20:01:35.466', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('180', '登录系统', '系统登录', '2016-01-28 23:47:11.336', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('181', '登录系统', '系统登录', '2016-01-28 23:54:29.248', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('182', '登录系统', '系统登录', '2016-01-29 00:04:40.667', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('183', '登录系统', '系统登录', '2016-01-29 00:12:28.925', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('184', '登录系统', '系统登录', '2016-01-29 00:26:44.796', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('185', '登录系统', '系统登录', '2016-01-29 00:32:16.539', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('186', '登录系统', '系统登录', '2016-01-29 10:29:49.343', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('187', '登录系统', '系统登录', '2016-01-29 14:34:30.511', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('188', '登录系统', '系统登录', '2016-01-29 14:34:42.192', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('189', '登录系统', '系统登录', '2016-01-29 14:53:14.04', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('190', '登录系统', '系统登录', '2016-01-29 15:00:26.956', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('191', '登录系统', '系统登录', '2016-01-29 15:01:46.367', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('192', '登录系统', '系统登录', '2016-01-29 15:06:56.291', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('193', '登录系统', '系统登录', '2016-01-29 15:13:23.007', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('194', '登录系统', '系统登录', '2016-01-29 15:15:05.737', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('195', '登录系统', '系统登录', '2016-01-29 15:24:07.828', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('196', '登录系统', '系统登录', '2016-01-29 15:31:36.23', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('197', '退出系统', '系统登出', '2016-01-29 15:32:35.212', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('198', '登录系统', '系统登录', '2016-01-29 15:32:36.438', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('199', '登录系统', '系统登录', '2016-01-30 20:20:21.635', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('200', '登录系统', '系统登录', '2016-01-30 20:26:43.223', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('201', '退出系统', '系统登出', '2016-01-30 20:29:03.692', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('202', '登录系统', '系统登录', '2016-01-30 20:29:04.894', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('203', '登录系统', '系统登录', '2016-01-30 20:38:01.94', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('204', '登录系统', '系统登录', '2016-01-30 20:45:32.189', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('205', '退出系统', '系统登出', '2016-01-30 20:49:15.322', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('206', '登录系统', '系统登录', '2016-01-30 20:49:16.459', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('207', '登录系统', '系统登录', '2016-01-30 22:08:22.15', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('208', '登录系统', '系统登录', '2016-01-30 22:11:46.606', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('209', '登录系统', '系统登录', '2016-01-31 11:33:57.664', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('210', '登录系统', '系统登录', '2016-01-31 11:45:27.588', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('211', '登录系统', '系统登录', '2016-01-31 11:49:11.758', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('212', '登录系统', '系统登录', '2016-01-31 12:14:43.962', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('213', '登录系统', '系统登录', '2016-01-31 18:13:16.021', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('214', '登录系统', '系统登录', '2016-01-31 19:09:24.43', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('215', '退出系统', '系统登出', '2016-01-31 19:09:58.375', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('216', '登录系统', '系统登录', '2016-01-31 19:09:59.856', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('217', '登录系统', '系统登录', '2016-01-31 19:11:16.485', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('218', '登录系统', '系统登录', '2016-01-31 19:21:51.946', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('219', '登录系统', '系统登录', '2016-01-31 19:30:09.111', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('220', '登录系统', '系统登录', '2016-01-31 19:36:37.719', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('221', '登录系统', '系统登录', '2016-01-31 19:49:06.874', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('222', '登录系统', '系统登录', '2016-01-31 22:17:09.531', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('223', '登录系统', '系统登录', '2016-01-31 23:10:32.238', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('224', '登录系统', '系统登录', '2016-01-31 23:18:11.247', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('225', '登录系统', '系统登录', '2016-02-01 15:50:45.267', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('226', '登录系统', '系统登录', '2016-02-01 15:55:19.341', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('227', '登录系统', '系统登录', '2016-02-01 16:00:19.974', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('228', '退出系统', '系统登出', '2016-02-01 16:00:44.677', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('229', '登录系统', '系统登录', '2016-02-01 16:00:45.846', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('230', '登录系统', '系统登录', '2016-02-01 16:04:08.155', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('231', '登录系统', '系统登录', '2016-02-01 16:09:14.358', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('232', '登录系统', '系统登录', '2016-02-01 16:15:35.878', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('233', '登录系统', '系统登录', '2016-02-01 16:28:01.449', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('234', '登录系统', '系统登录', '2016-02-01 16:36:10.109', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('235', '登录系统', '系统登录', '2016-02-01 16:46:37.659', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('236', '登录系统', '系统登录', '2016-02-01 16:51:30.649', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('237', '登录系统', '系统登录', '2016-02-01 16:54:49.719', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('238', '登录系统', '系统登录', '2016-02-01 17:05:24.177', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('239', '登录系统', '系统登录', '2016-02-01 17:16:16.644', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('240', '登录系统', '系统登录', '2016-02-01 17:28:54.098', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('241', '退出系统', '系统登出', '2016-02-01 17:30:00.573', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('242', '登录系统', '系统登录', '2016-02-01 17:30:01.777', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('243', '登录系统', '系统登录', '2016-02-01 17:33:39.362', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('244', '登录系统', '系统登录', '2016-02-01 17:54:01.672', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('245', '登录系统', '系统登录', '2016-02-01 18:27:24.459', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('246', '登录系统', '系统登录', '2016-02-01 21:32:53.312', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('247', '登录系统', '系统登录', '2016-02-01 21:36:12.315', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('248', '登录系统', '系统登录', '2016-02-02 08:15:00.248', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('249', '登录系统', '系统登录', '2016-02-02 08:17:08.569', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('250', '登录系统', '系统登录', '2016-02-02 08:32:57.648', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('251', '登录系统', '系统登录', '2016-02-02 08:35:13.582', '1', '5', '0:0:0:0:0:0:0:1');
INSERT INTO "public"."sys_log" VALUES ('252', '登录系统', '系统登录', '2016-02-02 08:40:05.403', '1', '5', '0:0:0:0:0:0:0:1');
...
CREATE TABLE "public"."meta_column" (
	"id" int8 NOT NULL DEFAULT nextval('seq_meta_dbcolumn'::regclass),
	"table_id" int8,
	...
	"index_id" int8,
	"field_code" varchar COLLATE "default",
	"check_label" int4
)
WITH (OIDS=FALSE);
...
COMMENT ON COLUMN "public"."meta_column"."check_label" IS '生效标记';

-- ----------------------------
--  Records of meta_column
-- ----------------------------
BEGIN;
INSERT INTO "public"."meta_column" VALUES ('1', '1', 'userId', '用户ID', '1', 'false', 'true', 'true', 'false', null, '用户ID', 'profile', '1', null, null);
COMMIT;
...
CREATE TABLE "public"."meta_project" (
	"id" int8 NOT NULL DEFAULT nextval('seq_meta_project'::regclass),
...
COMMENT ON COLUMN "public"."meta_project"."check_label" IS '启用标记';
...
CREATE TABLE "public"."etl_plugin" (
	"id" int8 NOT NULL DEFAULT nextval('seq_etl_plugin'::regclass),
...
CREATE TABLE "public"."etl_task" (
	"id" int8 NOT NULL DEFAULT nextval('seq_etl_task'::regclass),
...
CREATE TABLE "public"."etl_job_log" (
	"id" int8 NOT NULL DEFAULT nextval('seq_etl_job_log'::regclass),
	"task_id" int8,
...
COMMENT ON COLUMN "public"."etl_job_log"."log_type" IS '错误类型
0-告警
1-信息
2-错误';
...
-- ----------------------------
--  Table structure for job_jobclass
-- ----------------------------
DROP TABLE IF EXISTS "public"."job_jobclass";
CREATE TABLE "public"."job_jobclass" (
	"id" int8 NOT NULL DEFAULT nextval('seq_job_jobclass'::regclass),
	...
	"update_date" date,
	"updateby_id" int8,
	"product_id" varchar(50) COLLATE "default",
	"check_label" int4
)
WITH (OIDS=FALSE);
ALTER TABLE "public"."job_jobclass" OWNER TO "postgres";

COMMENT ON COLUMN "public"."job_jobclass"."id" IS 'id';
COMMENT ON COLUMN "public"."job_jobclass"."name" IS '名称';
COMMENT ON COLUMN "public"."job_jobclass"."job_type" IS 'job类别';
COMMENT ON COLUMN "public"."job_jobclass"."class_name" IS '类';
COMMENT ON COLUMN "public"."job_jobclass"."remark" IS '备注';
COMMENT ON COLUMN "public"."job_jobclass"."version" IS '版本';
COMMENT ON COLUMN "public"."job_jobclass"."create_date" IS '建立时间';
COMMENT ON COLUMN "public"."job_jobclass"."createby_id" IS '建立者';
COMMENT ON COLUMN "public"."job_jobclass"."update_date" IS '更新时间';
COMMENT ON COLUMN "public"."job_jobclass"."updateby_id" IS '更新者';
COMMENT ON COLUMN "public"."job_jobclass"."product_id" IS '产品ID';
COMMENT ON COLUMN "public"."job_jobclass"."check_label" IS '启用标记';
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."job_worker";
CREATE TABLE "public"."job_worker" (
	"id" int8 NOT NULL DEFAULT nextval('seq_job_worker'::regclass),
	"name" varchar(50) COLLATE "default",
	"jobclass_id" int8,
	"logic_name" varchar(100) COLLATE "default",
	"job_class" varchar(200) COLLATE "default",
	"sharding_total_count" int4,
	"cron" varchar(200) COLLATE "default",
	"sharding_item_parameters" varchar(4000) COLLATE "default",
	"job_parameter" varchar(200) COLLATE "default",
	"monitor_execution" int4,
	"process_count_interval" int4,
	"data_process_thread" int4,
	"fetch_data_count" int4,
	"maxtime_diff" int4,
	"failover" int4,
	"misfire" int4,
	"sharding_strategy_class" varchar(200) COLLATE "default",
	"disabled" int4,
	"overwrite" int4,
	"create_date" date,
	"createby_id" int8,
...
COMMENT ON TABLE "public"."job_worker" IS '调度工作者';
COMMENT ON COLUMN "public"."job_worker"."id" IS 'id';
COMMENT ON COLUMN "public"."job_worker"."name" IS '作业名称';
COMMENT ON COLUMN "public"."job_worker"."jobclass_id" IS '执行作业id';
COMMENT ON COLUMN "public"."job_worker"."logic_name" IS '逻辑名';
COMMENT ON COLUMN "public"."job_worker"."job_class" IS '作业实现类名称';
COMMENT ON COLUMN "public"."job_worker"."sharding_total_count" IS '作业分片总数';
COMMENT ON COLUMN "public"."job_worker"."cron" IS '作业启动时间的cron表达式';
COMMENT ON COLUMN "public"."job_worker"."sharding_item_parameters" IS '分片序列号和个性化参数对照表';
COMMENT ON COLUMN "public"."job_worker"."job_parameter" IS '作业自定义参数';
COMMENT ON COLUMN "public"."job_worker"."monitor_execution" IS '监控作业执行时状态';
COMMENT ON COLUMN "public"."job_worker"."process_count_interval" IS '统计作业处理数据数量的间隔时间';
COMMENT ON COLUMN "public"."job_worker"."data_process_thread" IS '处理数据的并发线程数';
COMMENT ON COLUMN "public"."job_worker"."fetch_data_count" IS '每次抓取的数据量';
COMMENT ON COLUMN "public"."job_worker"."maxtime_diff" IS '最大容忍的本机与注册中心的时间误差秒数';
COMMENT ON COLUMN "public"."job_worker"."failover" IS '是否开启失效转移';
COMMENT ON COLUMN "public"."job_worker"."misfire" IS '是否开启misfire';
COMMENT ON COLUMN "public"."job_worker"."sharding_strategy_class" IS '作业分片策略实现类全路径';
COMMENT ON COLUMN "public"."job_worker"."disabled" IS '作业是否禁止启动';
COMMENT ON COLUMN "public"."job_worker"."overwrite" IS '本地配置是否可覆盖注册中心配置';
COMMENT ON COLUMN "public"."job_worker"."create_date" IS '建立时间';
COMMENT ON COLUMN "public"."job_worker"."createby_id" IS '建立者';
COMMENT ON COLUMN "public"."job_worker"."update_date" IS '更新时间';
COMMENT ON COLUMN "public"."job_worker"."updateby_id" IS '更新者';
COMMENT ON COLUMN "public"."job_worker"."remark" IS '备注描述';
...
CREATE TABLE "public"."job_task_define" (
	"id" int8 NOT NULL DEFAULT nextval('seq_job_task_define'::regclass),
	"machine_id" int8,
	"worker_id" int8,
	"reg_id" int8,
	"remark" varchar(200) COLLATE "default",
...
COMMENT ON TABLE "public"."job_task_define" IS '执行任务配置';
COMMENT ON COLUMN "public"."job_task_define"."machine_id" IS '执行机器';
COMMENT ON COLUMN "public"."job_task_define"."worker_id" IS '执行者id';
COMMENT ON COLUMN "public"."job_task_define"."reg_id" IS '注册中心ID';
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."job_reg_center";
CREATE TABLE "public"."job_reg_center" (
	"id" int8 NOT NULL DEFAULT nextval('seq_job_reg_center'::regclass),
	"name" varchar(100) COLLATE "default",
	"zk_quorum_peer" varchar(200) COLLATE "default",
	"name_space" varchar(100) COLLATE "default",
	"base_sleep_time" int4,
	"max_sleep_time" int4,
	"max_retries" int4,
	"login_cert" varchar(50) COLLATE "default",
	"remark" varchar(200) COLLATE "default",
	"create_date" date,
	"createby_id" int8,
	"update_date" date,
...
WITH (OIDS=FALSE);
ALTER TABLE "public"."job_reg_center" OWNER TO "postgres";

COMMENT ON TABLE "public"."job_reg_center" IS '调度注册中心';
COMMENT ON COLUMN "public"."job_reg_center"."id" IS 'id';
COMMENT ON COLUMN "public"."job_reg_center"."name" IS '名称';
COMMENT ON COLUMN "public"."job_reg_center"."zk_quorum_peer" IS 'zk服务器连接列表';
COMMENT ON COLUMN "public"."job_reg_center"."name_space" IS '命名空间';
COMMENT ON COLUMN "public"."job_reg_center"."base_sleep_time" IS '待重试间隔时间(毫秒)';
COMMENT ON COLUMN "public"."job_reg_center"."max_sleep_time" IS '待重试间隔时间最大值';
COMMENT ON COLUMN "public"."job_reg_center"."max_retries" IS '最大重试次数';
COMMENT ON COLUMN "public"."job_reg_center"."login_cert" IS '登录凭证';
COMMENT ON COLUMN "public"."job_reg_center"."remark" IS '备注';
COMMENT ON COLUMN "public"."job_reg_center"."create_date" IS '建立时间';
COMMENT ON COLUMN "public"."job_reg_center"."createby_id" IS '建立者';
COMMENT ON COLUMN "public"."job_reg_center"."update_date" IS '更新时间';
COMMENT ON COLUMN "public"."job_reg_center"."updateby_id" IS '更新者';
COMMENT ON COLUMN "public"."job_reg_center"."check_label" IS '启用标记';
...
ALTER SEQUENCE "public"."seq_meta_dbtable" RESTART 6;
...
-- ----------------------------
--  Triggers structure for table meta_module
-- ----------------------------
CREATE CONSTRAINT TRIGGER "RI_ConstraintTrigger_c_18733" AFTER INSERT ON "public"."meta_module" NOT DEFERRABLE INITIALLY IMMEDIATE FOR EACH ROW EXECUTE PROCEDURE "RI_FKey_check_ins"();
COMMENT ON TRIGGER "RI_ConstraintTrigger_c_18733" ON "public"."meta_module" IS NULL;
CREATE CONSTRAINT TRIGGER "RI_ConstraintTrigger_c_18734" AFTER UPDATE ON "public"."meta_module" NOT DEFERRABLE INITIALLY IMMEDIATE FOR EACH ROW EXECUTE PROCEDURE "RI_FKey_check_upd"();
COMMENT ON TRIGGER "RI_ConstraintTrigger_c_18734" ON "public"."meta_module" IS NULL;

-- ----------------------------
--  Primary key structure for table sys_multi_lang
-- ----------------------------
ALTER TABLE "public"."sys_multi_lang" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Uniques structure for table sys_multi_lang
-- ----------------------------
...
-- ----------------------------
ALTER TABLE "public"."meta_project" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Indexes structure for table meta_project
-- ----------------------------
CREATE UNIQUE INDEX  "meta_project_id_key" ON "public"."meta_project" USING btree("id" ASC NULLS LAST);

-- ----------------------------
--  Triggers structure for table meta_project
-- ----------------------------
CREATE CONSTRAINT TRIGGER "RI_ConstraintTrigger_a_18731" AFTER DELETE ON "public"."meta_project" FROM "public"."meta_module" NOT DEFERRABLE INITIALLY IMMEDIATE FOR EACH ROW EXECUTE PROCEDURE "RI_FKey_cascade_del"();
...
-- ----------------------------
ALTER TABLE "public"."job_task_define" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

-- ----------------------------
--  Primary key structure for table job_reg_center
-- ----------------------------
ALTER TABLE "public"."job_reg_center" ADD PRIMARY KEY ("id") NOT DEFERRABLE INITIALLY IMMEDIATE;

...
<c:set var="pageTitle" value="${'添加ETL调度作业'}" scope="page" />
<html>
<head>
                           ...
                           <div class="form-wizard">
                              ...
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane" id="tab2">
                                    ...
                                    <table width="100%" class="dbform">
                                    	...
                                    	<tr>
											...
											<td class="fieldvalue"><input type="text"  style="width:95%;"  value="${obj.readerTask.remark}" name="readertask.remark"/></td>
                                    	</tr>
                                    	<tr>
                                    		<td colspan="4">
                                   ...
                                   <input type="hidden" value="" name="writertask.id" id="writertaskId"/>
                                    ...
                                    <table width="100%" class="dbform">
                                    	...
                                    	<tr>
                                    		...
                                    		<th class="fieldtitle">备注</th>
											<td class="fieldvalue"><input type="text"  style="width:95%;"  value="${obj.writerTask.remark}" name="writertask.remark"/></td>
                                    	</tr>
                                    	<tr>
                                    		<td colspan="4">
                                 ...
                                 <div class="tab-pane" id="tab4">
                                 	<table width="100%" class="dbform">
                                 		<tr>
                                    		<th class="fieldtitle">读取数据集</th> <input type="hidden" value="${obj.readerTask.datasetId}" id="rdatasetId" name="readtask.datasetId" />
                                    		...
                                    		<th class="fieldtitle">写入数据集</th> <input type="hidden"  value="${obj.writerTask.datasetId}"  id="wdatasetId" name="writertask.datasetId" />
                                    ...
                                    <div id="taskColumns" style="overflow:auto;">
		                            </div>
                                 </div>
...
<script type="text/javascript">
	...
	function removeColumnPair(pid){
		alert('dd');
		 $("#taskColumns").load(
					"${ctx}/etl/EtlJob/params/removeColumnPair?pairId="+pid
					); 
	 }

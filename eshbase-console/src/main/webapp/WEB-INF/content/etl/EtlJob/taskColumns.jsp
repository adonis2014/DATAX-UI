...
<%@ include file="/WEB-INF/content/common/common.jsp"%>
									<table width="100%" class="dbgrid">
                                   		...
                                   		<tbody>
                                   			...
                                   			<tr>
                                   				<td nowrap="nowrap"><input type="text" style="width:80px;" name="readColumnName" value="" /></td>
                                   				<td nowrap="nowrap"><input type="text" style="width:80px;"  name="writeColumnName" value="" /></td>
                                   				<td nowrap="nowrap"><mytags:dictSelect field="readerFieldType" codeType="1053" hasLabel="false" hasPSel="false" styleText="width:120px;"/> </td>
                                   				<td nowrap="nowrap"><mytags:dictSelect field="writerFieldType" codeType="1054" hasLabel="false" hasPSel="false" styleText="width:120px;"/></td>
                                   				<td nowrap="nowrap"><mytags:dictSelect field="functionName" codeType="1067" hasLabel="false" hasPSel="false" styleText="width:120px;"/></td>
                                   				<td nowrap="nowrap"><input type="text" name="script" value="" /></td>
                                   				<td nowrap="nowrap"><mytags:dictSelect field="scriptType" codeType="1063" hasLabel="false" hasPSel="false" styleText="width:120px;"/></td>
                                   				<td nowrap="nowrap"><input type="text"  style="width:120px;"  name="class_name" value="" /></td>
                                   				<td nowrap="nowrap"><input type="text"  style="width:40px;"  name="sortId" value="" /></td>
                                   				<td nowrap="nowrap"><input type="text"  style="width:180px;"  name="cloumn_remark" value="" /></td>
                                   			</tr>
                                   		</tbody>
                                   </table>
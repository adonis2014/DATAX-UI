	...
	<div id="art_main" class="fl">
		...
		<div class="art_img_box clearfix">
 			<div class="fr box_content">
				...
				<p class="intro">
					现在正坐在公司加着班，才发现加班也可以如此惬意。静静的边听歌，边敲着代码。
				</p>
		...
		<div class="art_img_box clearfix">
 			<div class="fr box_content">
	            ...
	            <div class="jiange"></div>
				<p class="intro">
					    ​每天都在想着发展模式，国美有佣金模式，淘宝有广告、平台、流量入口模式，红旗连锁有连锁、加盟、佣金、快卖模式，而一个好的报价网站该怎样发展一个模式使其能成为一个好的网站？
				</p>
				<ul class="clearfix"></ul>
				<div class="info">
					<table width="650" border="0" cellspacing="0" cellpadding="0">
		...
		<div class="art_img_box clearfix">
 			<div class="fr box_content">
	            ...
	            <div class="jiange"></div>
				<p class="intro">
					题：有两个数组如a[1,2,3,4,5],b[5,4,2,3,1]。那么[2,3]就是这两个数组的公共子数组。求任意两个数组的最大公共子数组长度。
				</p>
				<ul class="clearfix"></ul>
				<div class="info">
					<table width="650" border="0" cellspacing="0" cellpadding="0">
	                	<tbody>
	                    	<tr>
	                        	<td width="570">&nbsp;&nbsp;
	                   				<span> 时间 : 2014-07-12</span>| 
									<span>栏目 : <a href="#" title="查看其他中的全部文章">其他</a></span>| 
									<span>浏览 :  154</span>|
		...
		<div class="art_img_box clearfix">
 			<div class="fr box_content">
	            ...
	            <div class="jiange"></div>
				<p class="intro">
					用nginx代理的时候，可能会配置多域名多项目的配置，往往就会出现location与proxy_pass路劲不一致的情况。。。
				</p>
				<ul class="clearfix"></ul>
				<div class="info">
					<table width="650" border="0" cellspacing="0" cellpadding="0">
		...
		<div class="art_img_box clearfix">
 			<div class="fr box_content">
	            ...
	            <div class="jiange"></div>
				<p class="intro">
					在IE中使用window.location.href = "xxx"，会清空掉http中header[referer]的值，服务器端没法获取，解决办法动态创建一个a标签，再。。
				</p>
				<ul class="clearfix"></ul>
				<div class="info">
					<table width="650" border="0" cellspacing="0" cellpadding="0">
		...
		<div class="art_img_box clearfix">
 			<div class="fr box_content">
	            ...
	            <div class="jiange"></div>
				<p class="intro">
					生活充满了很多诱惑，我们身在一个风景区，却想着另外一个风景区。
				</p>
				<ul class="clearfix"></ul>
				<div class="info">
					<table width="650" border="0" cellspacing="0" cellpadding="0">

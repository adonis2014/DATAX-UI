...
<c:set var="pageTitle" value="${empty obj ? '添加作业任务':'修改作业任务' }" scope="page" />
<html>
<head>
				...
				<div class="span12">
					<div class="portlet box blue">
						...
						<div class="portlet-body form">
							<form action="${ctx}/job/JobTaskDefine/edit" class="form-horizontal form_sync" method="post" id="form1">

								<input type="hidden" value="${obj.id}" name="id">
								<div class="control-group">
									<label class="control-label">作业终端ID:</label>
									<div class="controls">
										<input type="text" class="span6 m-wrap" validate="{required:true}" name="machineId" value="${obj.machineId }" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">作业执行ID:</label>
									<div class="controls">
										<input type="text" class="span6 m-wrap" validate="{required:true}" name="workerId" value="${obj.workerId }" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">注册中心ID:</label>
									<div class="controls">
										<input type="text" class="span6 m-wrap" validate="{required:true}" name="regId" value="${obj.regId }" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">状态:</label>
									<div class="controls">
										<input type="text" class="span6 m-wrap" validate="{required:true}" name="status" value="${obj.status }" />
									</div>
								</div>
								<div class="control-group">

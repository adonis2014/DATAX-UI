...
<c:set var="pageTitle" value="${empty obj ? '添加元数据注释':'修改元数据注释' }" scope="page" />
<html>
<head>
				...
				<div class="span12">
					<div class="portlet box blue">
						...
						<div class="portlet-body form">
							<form action="${ctx}/meta/comment/edit" class="form-horizontal form_sync"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6 m-wrap"
											validate="{required:true}"
											name="comment" value="${obj.comment }" />
									</div>
								</div>
								<div class="control-group">

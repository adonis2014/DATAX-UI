					...
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							<div class="row-fluid">
								...
								<tool:operBtns modelKey="watch" modelName="meta"></tool:operBtns>
							</div>
...
$(document).ready(function() {
	...
	Page.initData(
		...
		null,
		[
			 	{cName:"user",cValue:"关注者",format:function(i,value,item){

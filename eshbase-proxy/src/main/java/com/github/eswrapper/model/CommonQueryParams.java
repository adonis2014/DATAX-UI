...
public class CommonQueryParams implements java.io.Serializable {
	...
	public CommonQueryParams(String clusterName,String htableName, String esIndexName, String esTypeName, List<FieldItem> selectColumns, List<WhereListParam> whereListParams, List<WhereFieldParam> wildFieldParams,
	...
	public QueryBuilder toQueryBuilder(){
		...
		for (WhereFieldParam fieldParam : missFieldParams) {
			QueryBuilder filterBuilder =QueryBuilders.existsQuery(fieldParam.getFieldName());
			qb.mustNot(filterBuilder);
		}
		return qb;
	}

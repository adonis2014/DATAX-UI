...
public class HBStringUtils extends StringUtils {
	...
	public static Date getDateValueFromResult(Result ur, byte[] familyName, String qualifier, String pattern) {
		...
		if (vb == null) {
			...
			return parseDate(Bytes.toString(vb), pattern);
		}
	}
	...
	public static List<String> getListStringFromResult(Result ur, byte[] familyName, String qualifier) {
		...
		if (vb == null) {
			...
			try {
				return mapper.readValue(Bytes.toString(ur.getValue(familyName, Bytes.toBytes(qualifier))), new TypeReference<List<String>>() {
				});
			} catch (IOException e) {
				e.printStackTrace();
				return null;
	...
	public static Map<String, Integer> getMapStringFromResult(Result ur, byte[] familyName, String qualifier) {
		...
		if (vb == null) {
			...
			try {
				return mapper.readValue(Bytes.toString(ur.getValue(familyName, Bytes.toBytes(qualifier))), new TypeReference<Map<String, Integer>>() {
				});
			} catch (IOException e) {
				e.printStackTrace();
				return null;
	...
	public static List<Integer> getListIntFromResult(Result ur, byte[] familyName, String qualifier) {
		...
		if (vb == null) {
			...
			try {
				return mapper.readValue(Bytes.toString(ur.getValue(familyName, Bytes.toBytes(qualifier))), new TypeReference<List<Integer>>() {
				});
			} catch (IOException e) {
				e.printStackTrace();
				return null;

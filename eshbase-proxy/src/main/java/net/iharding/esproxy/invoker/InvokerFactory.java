...
import net.iharding.esproxy.filter.Filter;
import net.iharding.esproxy.loadbalance.LoadBalance;
...
public class InvokerFactory {
    ...
    public Invoker generateEsHttpWriteInvoker(EsThrottle esSearchThrottle, SearchModel param) {
        ...
        String url = "http://" + targetNode.trim() +  param.getEsPath() + (queryStr == null ? "" : "?" + queryStr);
    ...
    public Invoker generateEsHttpSearchInvoker(EsThrottle esSearchThrottle, SearchModel param) {
        ...
        String url = "http://" + targetNode.trim() + param.getEsPath()+"?"+Constants.ES_HOTSTABLE_SPLIT_PARAM+"="+Constants.ES_HOTSTABLE_SPLIT_READVALUE + (queryStr == null ? "" : "&" + queryStr);

package net.iharding.esproxy.utils;
...
import net.iharding.esproxy.client.HttpClientFactory;
...
public class HttpClientUtil {
     ...
     * @throws IOException
     */
    public static String sendHttpRequestByHttpClient(String reqURL, String requestData, String contentType, String method,String username,String password) throws IOException {
        ...
        if ("GET".equalsIgnoreCase(method)) {
            if (requestData == null || "".equals(requestData))
                return sendGetRequest(reqURL, contentType, null,username,password);
            return sendPostRequest(reqURL, requestData, contentType, true,username,password);
        }
        if ("POST".equalsIgnoreCase(method)) {
            return sendPostRequest(reqURL, requestData, contentType, true,username,password);
        }
        if ("PUT".equalsIgnoreCase(method)) {
            return sendPutRequest(reqURL, requestData, contentType, true,username,password);
        }
        if ("DELETE".equalsIgnoreCase(method)) {
            return sendDELETERequest(reqURL, contentType, null,username,password);
        }
...
//            httpClient.getConnectionManager().shutdown(); // 关闭连接,释放资源
     ...
     * @return 远程主机响应正文
     */
    public static String sendGetRequest(String reqURL, String contentType, String decodeCharset,String username,String password) throws IOException {

        String responseContent = null; // 响应内容
        HttpEntity entity = null;
        DefaultHttpClient httpClient = HttpClientFactory.getHttpClient();// 创建默认的httpClient实例
...
//            httpClient.getConnectionManager().shutdown(); // 关闭连接,释放资源
     ...
     * @return 远程主机响应正文
     */
    public static String sendDELETERequest(String reqURL, String contentType, String decodeCharset,String username,String password) throws IOException {
    ...
    public static String sendPostRequest(String reqURL, String sendData, String contentType,
                                         boolean isEncoder,String username,String password) throws IOException {
        return sendPostRequest(reqURL, sendData, contentType, isEncoder, null, null,username,password);
    }
     ...
     */
    public static String sendPostRequest(String reqURL, String sendData, String contentType,
                                         boolean isEncoder, String encodeCharset, String decodeCharset,String username,String password) throws IOException {
    ...
    public static String sendPutRequest(String reqURL, String sendData, String contentType,
                                        boolean isEncoder,String username,String password) throws IOException {
        return sendPutRequest(reqURL, sendData, contentType, isEncoder, null, null,username,password);
    }
     ...
     * @throws IOException
     */
    public static String sendHttpRequestByJava(String reqURL, String requestData, String contentType, String method,String username,String password) throws IOException {
        contentType = contentType == null || "".equals(contentType) ? "text/plain; charset=UTF-8" : contentType;
        if ("GET".equalsIgnoreCase(method)) {
            if (requestData == null || "".equals(requestData))
                return sendRequestByJavaWithoutBody(reqURL, contentType, "GET",username,password);
            return sendRequestByJavaWithBody(reqURL, requestData, contentType, "GET",username,password);
        }
        if ("POST".equalsIgnoreCase(method)) {
            if (requestData == null || "".equals(requestData))
                return sendRequestByJavaWithoutBody(reqURL, contentType, "POST",username,password);
            return sendRequestByJavaWithBody(reqURL, requestData, contentType, "POST",username,password);
        }
        if ("PUT".equalsIgnoreCase(method)) {
            if (requestData == null || "".equals(requestData))
                return sendRequestByJavaWithoutBody(reqURL, contentType, "PUT",username,password);
            return sendRequestByJavaWithBody(reqURL, requestData, contentType, "PUT",username,password);
        }
        if ("DELETE".equalsIgnoreCase(method)) {
            if (requestData == null || "".equals(requestData))
                return sendRequestByJavaWithoutBody(reqURL, contentType, "DELETE",username,password);
            return sendRequestByJavaWithBody(reqURL, requestData, contentType, "DELETE",username,password);
        }
     ...
     */
    public static String sendRequestByJavaWithoutBody(String reqURL, String contentType, String method,String username,String password) throws IOException {
        ...
        try {
            ...
            return sendHttpRequestByHttpClient(reqURL, null, contentType, method,username,password);
        } finally {
            if (in != null) {
                try {
                    in.close();
    ...
    public static String sendPostRequestByJava(String reqURL,
                                               Map<String, String> params, String contentType, String method,String username,String password) throws IOException {
        ...
        return sendRequestByJavaWithBody(reqURL, sendData.toString(), contentType, method,username,password);
    }
     ...
     * //     * @see 本方法默认的连接超时时间为30秒,默认的读取超时时间为30秒
     */
    public static String sendRequestByJavaWithBody(String reqURL, String sendData, String contentType, String method,String username,String password) throws IOException {
        HttpURLConnection httpURLConnection = null;
        ...
        try {
            ...
            return sendHttpRequestByHttpClient(reqURL, sendData, contentType, method,username,password);

...
import org.nlpcn.es4sql.parse.ParentType;
...
public class Condition extends Where {
    ...
    public enum OPEAR {
		EQ, GT, LT, GTE, LTE, N, LIKE, NLIKE, IS, ISN, IN, NIN, BETWEEN, NBETWEEN, GEO_INTERSECTS, GEO_BOUNDING_BOX, GEO_DISTANCE, GEO_DISTANCE_RANGE, GEO_POLYGON, GEO_CELL, IN_TERMS, TERM, IDS_QUERY, NESTED_COMPLEX, CHILDREN_COMPLEX,PARENT_COMPLEX, SCRIPT;
	...
	public Condition(CONN conn, String name, OPEAR oper, Object value, Object relationshipType) throws SqlParseException {
		...
		if(this.relationshipType != null) {
			...
			}else if(relationshipType instanceof ParentType) {
				ParentType parentType = (ParentType)relationshipType;
	...
	public Condition(CONN conn, String name, String oper, Object value, Object relationshipType) throws SqlParseException {
        ...
        case "CHILDREN":
            ...
            break;
        case "PARENT":
            this.opear = OPEAR.PARENT_COMPLEX;
            break;    
        case "SCRIPT":
	...
	public String toString() {
        ...
        if(this.isNested()){
            ...
            result = "parent condition ";

            if(this.getParentType() != null){
                result+="on parent: " + this.getParentType() + " ";
            }        	
        }

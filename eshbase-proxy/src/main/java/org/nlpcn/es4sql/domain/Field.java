...
public class Field implements Cloneable{
	...
	public Field(String name, String alias) {
		...
		if (this.name.indexOf(":")<0){
			...
			String[] cols=StringUtils.split(name,":");
			this.columnName=cols[1];
			this.familyName=cols[0];
		}
		this.alias = alias;
        this.nested = null;
        this.children = null;
    ...
    public Field(String name, String alias, NestedType nested, ChildrenType children,ParentType parent) {
        this.name = name;
        this.alias = alias;
        this.nested = nested;

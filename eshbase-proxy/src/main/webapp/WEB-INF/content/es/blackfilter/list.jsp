...
<body>
	<div class="page-content">
		<div class="container-fluid">
			<!-- 页面导航 -->
			<tool:navBar pageTitle="过滤请求列表" pageTitleContent="ES管理-过滤请求" titleIcon="icon-home"/>
			<!-- 主体内容 -->
			<div class="row-fluid">
				<div class="span12">
...
$(document).ready(function() {
	...
	App.activeMenu("blackfilter/list");
	
	Page.initData(
		{
			url:"${ctx}/blackfilter/page",
			pageNo : 1,
			pageSize : 10,
			tableId : "#sample_1"
		},

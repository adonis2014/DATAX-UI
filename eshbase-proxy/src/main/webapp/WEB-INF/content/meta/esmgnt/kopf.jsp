...
<html>
<head>
<title>kopf管理入口</title>
</head>
<body>
	<div class="page-content">
		<div class="container-fluid">
			<!-- 页面导航 -->
						<tool:navBar pageTitle="head管理入口" pageTitleContent="ES集群管理-kopf管理入口" titleIcon="icon-home"/>
...
$(document).ready(function() {
	...
	App.activeMenu("esmgnt/thirdparty/kopf");

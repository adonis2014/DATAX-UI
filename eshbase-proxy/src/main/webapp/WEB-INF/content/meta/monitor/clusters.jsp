...
<body>
	<div class="page-content">
		<div class="container-fluid">
			<!-- 页面导航 -->
			<tool:navBar pageTitle="es资源监控" pageTitleContent="ES集群管理-es资源监控" titleIcon="icon-home"/>
			<!-- 主体内容 -->
			<div class="row-fluid">
				<div class="span12">
...
$(document).ready(function() {
	...
	App.activeMenu("esMonitor/clusters");
	...
	Page.initData(
		...
		[
			...
			{cName:"id",cValue:"监控",format:function(i,value,item){
	 			return "<a target='_blank' href='${ctx}/esmgnt/thirdparty/redirectKopf/"+item.id+"'>kopf</a>";
		 	}}
		 ]
	);
});

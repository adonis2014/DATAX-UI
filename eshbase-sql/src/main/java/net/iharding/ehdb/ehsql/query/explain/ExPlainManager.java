package net.iharding.ehdb.ehsql.query.explain;
...
public class ExPlainManager {
	...
	public static String explain(SQLRequest actionRequest) throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, SQLFeatureNotSupportedException {

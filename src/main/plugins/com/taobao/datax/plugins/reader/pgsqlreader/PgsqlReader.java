...
public class PgsqlReader extends Reader {
	...
	private Logger logger = Logger.getLogger(PgsqlReader.class);
	...
	public int init() {
		...
		this.pgsqlParams = param.getValue(ParamKey.pgsqlParams,"");
	...
	public List<PluginParam> split(PluginParam param){
		...
		if (StringUtils.isBlank(this.sql)) {
			...
			PgsqlReaderSplitter spliter = new PgsqlReaderSplitter(param);
			spliter.init();
	...
	private Properties createProperties() {
		...
		if (!StringUtils.isBlank(this.pgsqlParams)) {
			url = url + "&" + this.pgsqlParams;
		}
